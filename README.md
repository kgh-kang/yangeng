...
- **홈 → 결과 흐름**: 처음엔 로고·검색창·예시·최근검색이 화면 중앙, 검색하면 상단 스티키 헤더(로고+검색창+최근검색)로 전환, 로고 클릭 시 홈 복귀
...
- **전치사구·분사구·to부정사구는 ㄴ(L자) 받침** — 세로다리+가로받침선 위에 **전치사(분사/to)와 목적어를 함께** (둘 사이 구분선 없음), 목적어 수식어는 그 아래 `\`
