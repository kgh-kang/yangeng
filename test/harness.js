...
const CASES = [
    ...
    // ── 14주차 종합복습 연습문제 + GPS Reading 지문 (강의 공식 형식 라벨) ──
    ['He went to school.', 1, '1형식(go+부사구)'],
    ['There is a nice dream car.', 1, '1형식 there'],
    ['I am very fine, and you?', 2, '2형식'],
    ['She is so beautiful a lady.', 2, '2형식 so+adj'],
    ['I received a letter from him.', 3, '3형식'],
    ['He made a success of this election.', 3, '3형식 make a X of Y'],
    ['She will get a prize for good conduct.', 3, '3형식'],
    ['She showed me her photos.', 4, '4형식'],
    ['I teach you Engineering English.', 4, '4형식'],
    ['He gave them an address of welcome.', 4, '4형식'],
    ['She considers him a coward.', 5, '5형식 간주'],
    ['I told you to review it thoroughly.', 5, '5형식 tell+O+to부정사'],
    ['I will make you study English hard.', 5, '5형식 사역+원형부정사'],
    ['You watched her sing such a lovely song.', 5, '5형식 지각+원형부정사'],
    // GPS Reading 지문 (Ask a Satellite for Directions)
    ['No well-prepared boy scout troop would wander into the wilderness without a compass.', 1, 'R1 wander'],
    ['Soldiers relied on hand-held electronic gadgets.', 1, 'R3 relied on=자동사'],
    ['The devices can pinpoint a location instantly anywhere on the earth.', 3, 'R4 pinpoint'],
    ['Civilians can buy similar products from electronics companies.', 3, 'R5'],
    ['GPS receivers steer boaters around dangerous reefs.', 3, 'R6 steer'],
    ['The concept of the Global Positioning System is simple.', 2, 'R7'],
    ['A GPS receiver uses simultaneous readings from three different satellites.', 3, 'R9'],
    ['Relying on satellites rather than ground stations makes the system precise.', 5, 'R10 동명사주어+5형식'],
    ['But scouts may soon have a more sophisticated way to keep from getting lost.', 3, 'R2 have+to부정사형용사'],
